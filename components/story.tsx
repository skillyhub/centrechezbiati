...
export function Story() {
  return (
    <section id="story" className="mx-auto max-w-7xl px-6 py-24 lg:px-10 lg:py-32">
      <div className="grid gap-12 md:grid-cols-12 md:items-center">
        ...
        <div className="md:col-span-5 md:col-start-8">
          ...
          <p className="mt-6 font-sans text-base leading-relaxed text-muted-foreground">
            ...
            chefs, stylists, and hosts brings that same generosity to gatherings of every size —
            led by produce, guided by craft, and never far from the coast that shaped us.
          </p>
